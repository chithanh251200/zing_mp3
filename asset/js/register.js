...
//     fetch('view/register/registerEmail.php',
//         {
//             method: 'POST',
//             headers: {
...
//     fetch('view/register/verifyCodeEmail.php',
//         {
//             method: 'GET',
//             headers: {
//                 'Content-Type': 'application/json',
...
//                 document.querySelector('.LG__wapper-register___form').addEventListener('submit' , async function(e){
//                     e.preventDefault();

//                     const codeRegisterEmail = document.querySelector('.LG__wapper-register___form-codeEmail').value;
